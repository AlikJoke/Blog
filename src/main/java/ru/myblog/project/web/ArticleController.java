...
public class ArticleController {
	...
	public @ResponseBody ArticleResource doGet(@PathVariable("id") String id, Reference ref) {
	...
	public void doPost(@RequestBody ArticleResource resource, Reference ref) {
		ref.doPost(restOperations, resource);
	}
	
	@RequestMapping(value = ArticleReference.PATH, method = RequestMethod.PUT)
	@ResponseStatus(HttpStatus.ACCEPTED)
	public void doPut(@RequestBody ArticleResource resource, Reference ref) {
